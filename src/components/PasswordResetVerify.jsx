  ...
  return (
    <div className="w-full max-w-md bg-black/90 backdrop-blur-lg rounded-2xl p-4 sm:p-6 md:p-8 shadow-2xl shadow-red-500/20">
      <div className="text-center mb-6 md:mb-8">
        ...
        <h2 className="text-2xl sm:text-3xl font-bold text-white mb-1 sm:mb-2">Verify Reset Code</h2>
        <p className="text-sm sm:text-base text-gray-400">Enter the verification code sent to your email to reset your password</p>
      </div>
